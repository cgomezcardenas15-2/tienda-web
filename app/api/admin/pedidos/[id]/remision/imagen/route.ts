...
export async function GET(_request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const svg = `<svg width="1200" height="1500" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="150" y="88" class="t" font-size="34" font-weight="900" letter-spacing="8">NOVA</text><text x="150" y="111" fill="#579900" font-family="Arial" font-size="12" font-weight="700" letter-spacing="3">TODO LO QUE NECESITAS</text><text x="150" y="137" class="muted" font-family="Arial" font-size="13" font-weight="700">EMITIDO POR ${escapar(IDENTIDAD_COMERCIAL.nombreComercial.toUpperCase())}</text>
    ...
    <text x="600" y="1395" text-anchor="middle" fill="#52525b" font-family="Arial" font-size="15" font-weight="700">${escapar(IDENTIDAD_COMERCIAL.nombreComercial)} - ${escapar(IDENTIDAD_COMERCIAL.propietario)} - NIT ${escapar(IDENTIDAD_COMERCIAL.nitCompleto)}</text>
    <text x="600" y="1420" text-anchor="middle" fill="#71717a" font-family="Arial" font-size="14">${escapar(IDENTIDAD_COMERCIAL.responsabilidadIva)} - MATRICULA ${escapar(IDENTIDAD_COMERCIAL.matriculaMercantil)} - CIIU ${escapar(IDENTIDAD_COMERCIAL.actividadPrincipal)} / ${escapar(IDENTIDAD_COMERCIAL.actividadSecundaria)}</text>
    <text x="600" y="1445" text-anchor="middle" fill="#71717a" font-family="Arial" font-size="14">${escapar(IDENTIDAD_COMERCIAL.direccionCompleta)} - TEL. ${escapar(IDENTIDAD_COMERCIAL.telefono)}</text>
    <text x="600" y="1475" text-anchor="middle" fill="#a1a1aa" font-family="Arial" font-size="12" font-weight="700" letter-spacing="2">${escapar(IDENTIDAD_COMERCIAL.nombreComercial.toUpperCase())} - REMISION DE VENTA</text>
  </svg>`;

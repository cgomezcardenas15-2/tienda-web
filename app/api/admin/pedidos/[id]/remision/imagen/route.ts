...
export async function GET(_request: Request, context: { params: Promise<{ id: string }> }) {
  ...
  const svg = `<svg width="1200" height="1500" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="600" y="1420" text-anchor="middle" fill="#71717a" font-family="Arial" font-size="14">${escapar(IDENTIDAD_COMERCIAL.responsabilidadIva)} - Telefono y WhatsApp: ${escapar(IDENTIDAD_COMERCIAL.telefono)} - ${escapar(IDENTIDAD_COMERCIAL.correo)}</text>
    <text x="600" y="1445" text-anchor="middle" fill="#71717a" font-family="Arial" font-size="14">${escapar(IDENTIDAD_COMERCIAL.direccionCompleta)}</text>
    <text x="600" y="1475" text-anchor="middle" fill="#a1a1aa" font-family="Arial" font-size="12" font-weight="700" letter-spacing="2">${escapar(IDENTIDAD_COMERCIAL.nombreComercial.toUpperCase())} - REMISION COMERCIAL - DOCUMENTO NO FISCAL</text>
  </svg>`;
